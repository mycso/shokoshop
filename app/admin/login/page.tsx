  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-8 w-full max-w-sm">
        ...
        <h1 className="text-xl font-bold text-gray-900 dark:text-white text-center mb-1">Admin Login</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 text-center mb-6">ShokoShop</p>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            <input
              ...
              autoFocus
              className="w-full px-4 py-3 pr-11 border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand"
            />
            <button
              type="button"
              onClick={() => setShow((s) => !s)}
